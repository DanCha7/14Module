...
import "./aboutdamen.css";

const AboutDamen = () => {
  return (
    <section className="about__damen container">
      <p className="ab__title">ABOUT</p>
      <div className="iam__know__more">
        <h2 className="title__iam">I AM DAMIEN</h2>
        <CustomButton title="Know More→" />
      </div>

      <div className="intro__sec__it">
        <img
          className="damen__looks__img"
          src="/src/assets/images/DamenLooks.png"
          alt="damen__looks"
        />
        <div className="cards__info">
          <div className="first__block__title">
            <div className="star__title__block">
              <img src="/src/assets/images/star.svg" alt="star" />
              <h3>Introduction</h3>
            </div>

            <p className="description__title__block">
          ...
          <div className="second__block__title">
            <div className="star__title__block">
            ...
            <div className="under__block__off">
              ...
              <div className="buttons__block__damien">
                <CustomButton title="Let’s Work" />
