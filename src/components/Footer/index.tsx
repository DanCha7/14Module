  ...
  return (
    <>
      <footer className="footer">
        <section className="first__segment__footer">
          <div className="banner__photography" />
          <div className="footer__content container">
            <div className="left__block__footer">
              <p className="title__left__block">
                A MORE MEANINGFUL HOME PHOTOGRAPHY
              </p>
              <div className="block__size">
                <p className="tittle__lets__work">LET’S</p>
                <ButtonArrow />
              </div>
              <p className="tittle__lets__work">WORK TOGETHER</p>
            </div>
            <div className="right__block__footer">
              <div className="element__navbar">
                <p className="name__list__footer">HOME</p>
                <ul>
                  <li className="list__item__footer">ABOUT ME</li>
                  <li className="list__item__footer">MY WORKS</li>
                  <li className="list__item__footer">TESTIMONIALS</li>
                </ul>
              </div>
              <div className="element__navbar">
                <p className="name__list__footer">CLIENTS</p>
                <ul>
                  <li className="list__item__footer">KLOVESTO</li>
                  <li className="list__item__footer">Nukeway</li>
                  <li className="list__item__footer">Cloven’s</li>
                  <li className="list__item__footer">MenVol</li>
                </ul>
              </div>
              <div className="element__navbar">
                <p className="name__list__footer">Portfolio</p>
                <ul>
                  <li className="list__item__footer">Events</li>
                  <li className="list__item__footer">Portrait</li>
                  <li className="list__item__footer">Commerciale</li>
                  <li className="list__item__footer">Wedding</li>
                  <li className="list__item__footer">Wedding</li>
                </ul>
              </div>
              <div className="element__navbar">
                <p className="name__list__footer">Services</p>
                <ul>
                  <li className="list__item__footer">Events</li>
                  <li className="list__item__footer">Portrait</li>
                  <li className="list__item__footer">Commerciale</li>
        ...
        <section className="rights__footer">
          <div className="rights__sum container">
